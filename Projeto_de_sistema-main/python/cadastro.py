...
from PySide6.QtWidgets import (QApplication, QFrame, QLabel, QLineEdit,
                               QMainWindow, QPushButton, QWidget, QMenuBar, QMessageBox)
...
class Ui_tela_Cadastro(object):
    def setupUi(self, tela_Cadastro):
        ...
        # Definir o fundo da janela principal como preto (mesma cor do card)
        tela_Cadastro.setStyleSheet(u"background-color: rgb(0, 0, 0);")
...
# Para testar standalone (opcional)
if __name__ == "__main__":
    import sys
    app = QApplication(sys.argv)
    tela_Cadastro = QMainWindow()
    ui = Ui_tela_Cadastro()
